 ...
 */
namespace payzone\PaymentGateway\Model;

class Gateway extends \Magento\Payment\Model\Method\AbstractMethod {
	const _MODULE = 'payzone_PaymentGateway';
	const DIRECT_URL = 'https://gw1.payzoneonelinepayments2.com/direct/';
	const HOSTED_URL = 'https://gw1.payzoneonlinepayments2.com/paymentform/';
			...
			if ($data['responseCode'] == 65802) {
				...
				if ($data['responseCode'] == 0){
					...
					if($order->getStatus() != $status) {
						...
						$objectManager->create('payzone\PaymentGateway\Model\Trans')
	...
	private function buildStatus($data) {
		$ordermessage = "payzone Payment<br/><br/>" .
	...
	public function getOrderPlaceRedirectUrl() {
		return $this->_urlBuilder->getUrl('payzone/order/process');
	}
}
