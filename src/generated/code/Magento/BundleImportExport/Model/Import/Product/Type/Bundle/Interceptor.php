...
class Interceptor extends \Magento\BundleImportExport\Model\Import\Product\Type\Bundle implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function prepareAttributesWithDefaultValueForSave(array $rowData, $withDefaultValue = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::prepareAttributesWithDefaultValueForSave($rowData, $withDefaultValue);
        } else {
            return $this->___callPlugins('prepareAttributesWithDefaultValueForSave', func_get_args(), $pluginInfo);
        }
    }
}
