...
function (_Extensible) {
  ...
  _createClass(_CategoryConfigurableAttributes, [{
    ...
    value: function getPriceLabel(option) {
      ...
      if (from === '*') {
        return __('Up to %s', Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatPrice"])(to, currency_code));
      }

      if (to === '*') {
        return __('From %s', Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatPrice"])(from, currency_code));
      }

      return __('From %s, to %s', Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatPrice"])(from, currency_code), Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatPrice"])(to, currency_code));
    }
  }, {
