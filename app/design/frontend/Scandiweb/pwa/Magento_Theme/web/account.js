...
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_store_Notification_Notification_action__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/store/Notification/Notification.action */ "../../../../../vendor/scandipwa/source/src/app/store/Notification/Notification.action.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_store_Overlay_Overlay_action__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/store/Overlay/Overlay.action */ "../../../../../vendor/scandipwa/source/src/app/store/Overlay/Overlay.action.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_type_Device__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/type/Device */ "../../../../../vendor/scandipwa/source/src/app/type/Device.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_util_Auth__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/util/Auth */ "../../../../../vendor/scandipwa/source/src/app/util/Auth/index.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_util_History__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/util/History */ "../../../../../vendor/scandipwa/source/src/app/util/History/index.js");
...
/* harmony import */ var _MyAccountOverlay_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./MyAccountOverlay.component */ "../../../../../vendor/scandipwa/source/src/app/component/MyAccountOverlay/MyAccountOverlay.component.js");
/* harmony import */ var _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./MyAccountOverlay.config */ "../../../../../vendor/scandipwa/source/src/app/component/MyAccountOverlay/MyAccountOverlay.config.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var mapDispatchToProps = middleware(function (dispatch) {
  return {
    hideActiveOverlay: function hideActiveOverlay() {
      return dispatch(Object(_app_design_frontend_Scandiweb_pwa_src_app_store_Overlay_Overlay_action__WEBPACK_IMPORTED_MODULE_8__["hideActiveOverlay"])());
    },
    showNotification: function showNotification(type, message) {
      return dispatch(Object(_app_design_frontend_Scandiweb_pwa_src_app_store_Notification_Notification_action__WEBPACK_IMPORTED_MODULE_7__["showNotification"])(type, message));
    },
    showOverlay: function showOverlay(overlayKey) {
      return dispatch(Object(_app_design_frontend_Scandiweb_pwa_src_app_store_Overlay_Overlay_action__WEBPACK_IMPORTED_MODULE_8__["toggleOverlayByKey"])(overlayKey));
    },
    setHeaderState: function setHeaderState(headerState) {
      return dispatch(Object(_app_design_frontend_Scandiweb_pwa_src_app_store_Navigation_Navigation_action__WEBPACK_IMPORTED_MODULE_5__["changeNavigationState"])(_app_design_frontend_Scandiweb_pwa_src_app_store_Navigation_Navigation_reducer__WEBPACK_IMPORTED_MODULE_6__["TOP_NAVIGATION_TYPE"], headerState));
    },
    goToPreviousHeaderState: function goToPreviousHeaderState() {
...
function (_Extensible) {
  ...
  function _MyAccountOverlayContainer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "redirectOrGetState", function (props) {
      var showOverlay = props.showOverlay,
          ...
          device = props.device;
      var _history$location = _app_design_frontend_Scandiweb_pwa_src_app_util_History__WEBPACK_IMPORTED_MODULE_11__["default"].location,
      ...
      var state = {
        state: Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Auth__WEBPACK_IMPORTED_MODULE_10__["isSignedIn"])() ? _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_LOGGED_IN"] : _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_SIGN_IN"],
      ...
      state.state = _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_FORGOT_PASSWORD"];
      setHeaderState({
        ...
        onBackClick: function onBackClick(e) {
          _app_design_frontend_Scandiweb_pwa_src_app_util_History__WEBPACK_IMPORTED_MODULE_11__["default"].push({
            pathname: Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Url__WEBPACK_IMPORTED_MODULE_12__["appendWithStoreCode"])('/my-account')
          });
      ...
      showOverlay(_MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["CUSTOMER_ACCOUNT_OVERLAY_KEY"]);
      return state;
    });
  ...
  _createClass(_MyAccountOverlayContainer, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var pathname = _app_design_frontend_Scandiweb_pwa_src_app_util_History__WEBPACK_IMPORTED_MODULE_11__["default"].location.pathname;
      var _this$props = this.props,
      ...
      if (!pathname.includes(_app_design_frontend_Scandiweb_pwa_src_app_route_Checkout_Checkout_config__WEBPACK_IMPORTED_MODULE_4__["CHECKOUT_URL"]) && newMyAccountState === _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_LOGGED_IN"]) {
        _app_design_frontend_Scandiweb_pwa_src_app_util_History__WEBPACK_IMPORTED_MODULE_11__["default"].push({
          pathname: Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Url__WEBPACK_IMPORTED_MODULE_12__["appendWithStoreCode"])('/my-account/dashboard')
        });
      }
    }
  }, {
    ...
    value: function handleForgotPassword(e) {
      ...
      this.setState({
        state: _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_FORGOT_PASSWORD"]
      });
      setHeaderState({
        name: _app_design_frontend_Scandiweb_pwa_src_app_component_Header_Header_config__WEBPACK_IMPORTED_MODULE_3__["CUSTOMER_SUB_ACCOUNT"],
    ...
    value: function handleSignIn(e) {
      ...
      e.nativeEvent.stopImmediatePropagation();
      this.setState({
        state: _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_SIGN_IN"]
      });
      setHeaderState({
        name: _app_design_frontend_Scandiweb_pwa_src_app_component_Header_Header_config__WEBPACK_IMPORTED_MODULE_3__["CUSTOMER_ACCOUNT"],
        title: __('Sign in')
    ...
    value: function handleCreateAccount(e) {
      ...
      e.nativeEvent.stopImmediatePropagation();
      this.setState({
        state: _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_CREATE_ACCOUNT"]
      });
      setHeaderState({
        name: _app_design_frontend_Scandiweb_pwa_src_app_component_Header_Header_config__WEBPACK_IMPORTED_MODULE_3__["CUSTOMER_SUB_ACCOUNT"],
    ...
    value: function render() {
      return (
        /*#__PURE__*/
        _checkBEM(React, _MyAccountOverlay_component__WEBPACK_IMPORTED_MODULE_13__["default"], _extends({}, this.props, this.state, this.containerFunctions))
      );
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, state) {
      ...
      var _history$location2 = _app_design_frontend_Scandiweb_pwa_src_app_util_History__WEBPACK_IMPORTED_MODULE_11__["default"].location,
      ...
      if (!device.isMobile) {
        if (!isOverlayVisible && !isSignedIn) {
          if (pathname !== '/forgot-password' && !isForgotPassword) {
            stateToBeUpdated.state = _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_SIGN_IN"];
          }
        } else if (!isOverlayVisible && isSignedIn) {
          stateToBeUpdated.state = _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_LOGGED_IN"];
        }
      }

      if (myAccountState !== _MyAccountOverlay_config__WEBPACK_IMPORTED_MODULE_14__["STATE_LOGGED_IN"] && isSignedIn) {
...
_defineProperty(MyAccountOverlayContainer, "propTypes", {
  ...
  isCheckout: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.bool,
  hideActiveOverlay: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  device: _app_design_frontend_Scandiweb_pwa_src_app_type_Device__WEBPACK_IMPORTED_MODULE_9__["DeviceType"].isRequired
});
...
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_type_Account__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/type/Account */ "../../../../../vendor/scandipwa/source/src/app/type/Account.js");
/* harmony import */ var _MyAccountTabList_style__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./MyAccountTabList.style */ "../../../../../vendor/scandipwa/source/src/app/component/MyAccountTabList/MyAccountTabList.style.scss");
/* harmony import */ var _MyAccountTabList_style__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_MyAccountTabList_style__WEBPACK_IMPORTED_MODULE_5__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
