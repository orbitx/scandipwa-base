  ...
  _createClass(_MyAccountSignInContainer, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(fields) {
        var _this$props2, signIn, showNotification, onSignIn, setLoadingState, _ref3, message;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props2 = this.props, signIn = _this$props2.signIn, showNotification = _this$props2.showNotification, onSignIn = _this$props2.onSignIn, setLoadingState = _this$props2.setLoadingState;
                _context.prev = 1;
                _context.next = 4;
