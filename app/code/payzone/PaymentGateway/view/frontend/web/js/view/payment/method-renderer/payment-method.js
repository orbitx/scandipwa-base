...
define(
	...
	function (Component, url) {
		...
		return Component.extend({
			defaults: {
				template: 'payzone_PaymentGateway/payment/form'
			},
			...
			afterPlaceOrder: function () {
				...
				var uri = url.build('payzone/order/process');
				if (document.cookie.indexOf('payzone_PaymentGateway_IntegrationMethod=iframe') > -1 ) {
